...
ROUTING_TABLE = {
    "RESEARCH_DEEPSEEK": "core.agents.researcher.deepseek_browser_agent.DeepSeekBrowserAgent",
    "RESEARCH_CLAUDE": "core.agents.claude.claude_agent_improved.ClaudeAgentImproved",
    "RESEARCH_GENERAL": "core.agents.researcher.deepseek_browser_agent.DeepSeekBrowserAgent",
