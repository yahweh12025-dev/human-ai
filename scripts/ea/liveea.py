...
def compile_ea() -> bool:
    ...
    # compile_ea.sh is hardcoded to MetalEA — pass the EA name via a modified invocation
    # We call it with a patched env variable the script reads, or duplicate the script logic inline
    result = subprocess.run(
        ["bash", str(COMPILE_SCRIPT), "11", EA_NAME],
