#!/usr/bin/env python3
"""
Claude.ai session seeder that explicitly uses the user-data-dir.
"""
...
@browser(
    # Explicitly set the user data directory to use your persistent profile
    user_data_dir="/home/yahwehatwork/.browser-profile/google",
    # Optional: other browser options
    headless=False,  # We'll control this via environment variable or parameter
    # close_on_complete=False,  # Keep browser open after script ends? Not sure if this exists.
)
...
if __name__ == "__main__":
    print("🌱 Claude.ai Session Seeding Tool (with explicit profile)")
    print("=" * 60)
    print("This will open a browser using your persistent profile at:")
    print("   /home/yahwehatwork/.browser-profile/google protex")
